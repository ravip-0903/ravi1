{* $Id: calendar.tpl 12622 2011-06-03 12:58:08Z alexions $ *}
...
<input type="text" id="{$date_id}" name="{$date_name}" class="input-text{if $date_meta} {$date_meta}{/if} cm-calendar" value="{if $date_val}{$date_val|date_format:"`$date_format`"}{/if}" {$extra} size="10" />&nbsp;<img src="{$images_dir}/icons/calendar.png" class="cm-external-focus calendar-but" rev="{$date_id}" title="{$lang.calendar}" alt="{$lang.calendar}" />
