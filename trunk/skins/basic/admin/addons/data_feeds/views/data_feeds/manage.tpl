...
<tr>
	...
	<td class="nowrap">
		...
		{capture name="tools_items"}
			<ul>
				<li><a class="cm-confirm" href="{"exim.export_datafeed?datafeed_ids[]=`$datafeed.datafeed_id`&amp;location=L"|fn_url}">{$lang.local_export}</a></li>
				<li><a class="cm-confirm" href="{"exim.export_datafeed?datafeed_ids[]=`$datafeed.datafeed_id`&amp;location=S"|fn_url}">{$lang.export_to_server}</a></li>
				<li><a class="cm-confirm" href="{"exim.export_datafeed?datafeed_ids[]=`$datafeed.datafeed_id`&amp;location=F"|fn_url}">{$lang.upload_to_ftp}</a></li>
			</ul>
		{/capture}
