{* $Id: returns.tpl 12143 2011-03-31 12:02:30Z subkey $ *}
...
{if $return_requests}
	<div class="buttons-container buttons-bg">
        ...
        {include file="buttons/button.tpl" but_text="export orders" but_name="dispatch[rma.bulk_export]" but_role="button_main" but_meta="cm-process-items"}
