{* $Id: orders_search_form.tpl 12235 2011-04-11 13:11:24Z alexions $ *}

{capture name="section"}

<form action="{""|fn_url}" name="orders_search_form" method="get">
{if $smarty.request.ff}
<input type="hidden" name="ff" value="{$smarty.request.ff}"/>
{/if}
...
<tr>
	<td class="nowrap search-field">
    	<div class="order_search_mng">
            ...
            <input type="hidden" name="redirect_if_one" value="Y" /><!-- Add By Paresh -->
        </div>
    </td>
    ...
    <td class="nowrap search-field"></td>
    <td class="buttons-container"></td>
</tr>
<tr>
	<td class="nowrap search-field">
