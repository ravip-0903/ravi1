...
<tr {cycle values="class=\"table-row\", "}>
	...
	<td class="nowrap">
		...
		{hook name="profiles:list_extra_links"}
			...
			{*{if (!"COMPANY_ID"|defined && !(!$user.company_id && $user.is_root == "Y")) || ("COMPANY_ID"|defined && $user.user_type == "A" && $user.company_id == $smarty.const.COMPANY_ID && $user.is_root == "N")}
...
<div class="buttons-container buttons-bg">
	<div class="float-left">
		...
		{else}
			...
			{include file="common_templates/tools.tpl" prefix="`$smarty.request.content_id`" hide_actions=true tools_list=$smarty.capture.tools_list display="inline" link_text=$lang.choose_action}
		{/if}
	</div>	
</div>
{/if}
