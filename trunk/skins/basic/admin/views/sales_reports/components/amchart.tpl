...
<!-- amchart script-->
	...
	<script type="text/javascript">
		...
		var so{$_uid} = new SWFObject("{$config.current_path}/lib/amcharts/am{$type}/am{$type}8296.swf", "{$chart_id}am{$type}", "{$chart_width|default:'650'}", "{$chart_height|default:'500'}", "8", "{$chart_bgcolor|default:'#FFFFFF'}");
