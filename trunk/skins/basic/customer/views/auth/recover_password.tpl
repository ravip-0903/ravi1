...
<div class="center">
	<div class="recover-password">
		<label class="strong cm-trim cm-required cm-email" for="login_id">{$lang.email}:</label>
		<p class="break"><input type="email" id="login_id" name="user_email" size="30" value="" class="input-text cm-focus" /></p>
	</div>
