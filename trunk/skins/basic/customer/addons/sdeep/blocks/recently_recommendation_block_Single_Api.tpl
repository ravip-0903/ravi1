{** block-description:recently_recommendation_hr_block_single_Api **}
<div id="club_block_cat" style="display:none;">
...
<script>
    ...
    function recent_recommend_category(){
...
//Recommendation block starts here
        ...
        if(!data.rhf || !data.rhf.recommendations || !data.rhf.recommendations.recommendedItems || data.rhf.recommendations.recommendedItems.length == 0 ||!data.rhf.recentHistory || !data.rhf.recentHistory.viewedItems || data.rhf.recentHistory.viewedItems.length == 0){
                $("#club_block_cat").hide();    
