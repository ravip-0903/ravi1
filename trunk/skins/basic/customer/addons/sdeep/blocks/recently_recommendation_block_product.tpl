{** block-description:recently_recommendation_hr_block_product **}
<div id="club_block_prod">
...
<script>
    $(document).ready(function(){
                ...
                var prod_id =" ";
                {/literal}{if $smarty.request.product_id}{literal}var prod_id ={/literal} {$smarty.request.product_id};{/if}{literal}
