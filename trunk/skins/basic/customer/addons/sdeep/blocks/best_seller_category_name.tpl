{** block-description:best_seller_categoryname_block **}
...
<script>
    ...
    $(document).ready(function(){
        ...
        var url = "http://api.targetingmantra.com/TMWidgets?w=bs&mid=130915&pid="+prod_id+"&limit="+limit +"&json=true&catid={/literal}{$category_name_new_arrival}{literal}&callback=?";
