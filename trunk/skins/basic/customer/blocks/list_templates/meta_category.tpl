...
<ul id="{$block.block_id}" class="jcarousel-skin-ie7">
    ...
    {foreach from=$products item="product" name="productlisting"}
        ...
        <li>
            <div id="box_metacategory" class="box_metacategory" style="{if $block.properties.show_key_feature=='Y'}height:340px;{/if}">
                ...
                <div class="box_metacategory_wishList" style="top:141px; width:172px;">
                    ...
                    <div class="bottom" style="float:left; width:173px;"></div>
                </div>
...
<script type="text/javascript">
	...
	if({/literal}{$config.isResponsive}{literal} && $(window).width()<801){
			    ...
			    jQuery_1_10_2("#{/literal}{$block.block_id}{literal}").owlCarousel(optionsOwl_category);

        // Custom Navigation Events
        jQuery_1_10_2(".jcarousel-next").click(function(){
            var owl = jQuery_1_10_2(this).parent().find("#{/literal}{$block.block_id}{literal}");
            owl.trigger('owl.next');
        });
        jQuery_1_10_2(".jcarousel-prev").click(function(){
            var owl = jQuery_1_10_2(this).parent().find("#{/literal}{$block.block_id}{literal}");
            owl.trigger('owl.prev');
        });
                    }
                    else{
                        $("#{/literal}{$block.block_id}{literal}").jcarousel({
