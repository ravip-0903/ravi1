...
<div id="page_2" class="{if $new_width_val=="33"}grid_3{elseif $new_width_val=="50"}grid_2 {else}grid_3{/if}">
...
{if $product.discount || $product.list_discount_prc || ($after_apply_promotion!=0)}
    ...
    {*anoop code for value added service stamps*}
        {if $product.value_added_services.qty_disc_flag == '1'}
            <div class="icon_EDB_small" style="top: 215px;">  
            </div>
        {/if}
        {if $product.value_added_services.min_qty_disc_flag == '1'}
            <div class="icon_EDR_small" style="top: 215px;">
            </div>
        {/if}
...
<span class="box_metacategory_price" style="margin-left:0px;">
    MRP: {$product.list_price|format_price:$currencies.$secondary_currency:""}
</span>
{/if}
{if $product.is_wholesale_product == 1 && !empty($product.retail_price) && $product.retail_price > $product.price && $product.retail_price < $product.list_price}
    <span class="box_metacategory_price no_mobile" style="margin:0;">
        {$lang.retail_price}{$product.retail_price|format_price:$currencies.$secondary_currency:""}
    </span>
{/if}
{if $after_apply_promotion !=0}
