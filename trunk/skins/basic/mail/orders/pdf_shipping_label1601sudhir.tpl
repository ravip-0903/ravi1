...
<br />Carier Barcode Goes here</div></td>
		...
		<tr valign="top">
			...
			<td width="75%">
				...
				<p style="margin: 2px 0px 3px 0px;font-size:25px;">
		...
		<table width="100%" border="1" cellpadding="0" cellspacing="0" style="border-collapse:collapse; border:1px solid #999; padding: 25px 0px 25px 0px;">
			...
			{hook name="orders:items_list_row"}
				...
				<tr>
					...
					<td style="padding: 5px 10px; background-color: #ffffff; text-align: center; font-size: 13px; font-family: Arial;">{$oi.product|unescape|default:$lang.deleted_product}</td>
					<td style="padding: 5px 10px; background-color: #ffffff; text-align: center; font-size: 13px; font-family: Arial;">{$oi.amount}</td>
					<td style="padding: 5px 10px; background-color: #ffffff; text-align: right; font-size: 13px; font-family: Arial;">{if $oi.extra.exclude_from_calculate}{$lang.free}{else}{include file="common_templates/price.tpl" value=$oi.original_price}{/if}</td>
					{if $order_info.use_discount}
					<td style="padding: 5px 10px; background-color: #ffffff; text-align: right; font-size: 13px; font-family: Arial;">{if $oi.extra.discount|floatval}{include file="common_templates/price.tpl" value=$oi.extra.discount}{else}&nbsp;-&nbsp;{/if}</td>
					{/if}
					{if $order_info.taxes && $settings.General.tax_calculation != "subtotal"}
						<td style="padding: 5px 10px; background-color: #ffffff; text-align: right; font-size: 13px; font-family: Arial;">{if $oi.tax_value}{include file="common_templates/price.tpl" value=$oi.tax_value}{else}&nbsp;-&nbsp;{/if}</td>
					{/if}
		
					<td style="padding: 5px 10px; background-color: #ffffff; text-align: right; white-space: nowrap; font-size: 13px; font-family: Arial;">{if $oi.extra.exclude_from_calculate}{$lang.free}{else}{include file="common_templates/price.tpl" value=$oi.display_subtotal}{/if}&nbsp;</td>
				</tr>
				{/if}
			{/hook}
			{/foreach}
        ...
        {* Order totals *}
			<table cellpadding="0" cellspacing="0" border="0" width="100%" height="250px">
			<tr>
				<td align="right">
				<table border="0" style="padding: 3px 0px 12px 0px;">
				<tr>
					<td style="text-align: right; white-space: nowrap; font-size: 15px; font-family: Arial;">{$lang.subtotal}:&nbsp;</td>
					<td style="text-align: right; white-space: nowrap; font-size: 15px; font-family: Arial;">{include file="common_templates/price.tpl" value=$order_info.display_subtotal}</td>
				</tr>
				{if $order_info.discount|floatval}
				<tr>
					<td style="text-align: right; white-space: nowrap; font-size: 15px; font-family: Arial;"><b>{$lang.including_discount}:</b>&nbsp;</td>
					<td style="text-align: right; white-space: nowrap; font-size: 15px; font-family: Arial;">
				...
				<tr>
					<td style="text-align: right; white-space: nowrap; font-size: 15px; font-family: Arial;">{$lang.order_discount}:</td>
					<td style="text-align: right; white-space: nowrap; font-size: 15px; font-family: Arial;">
				...
				{if $order_info.taxes}
				<tr>
					<td style="text-align: right; white-space: nowrap; font-size: 15px; font-family: Arial;"><b>{$lang.taxes}:</b>&nbsp;</td>
					<td style="text-align: right; white-space: nowrap; font-size: 15px; font-family: Arial;">&nbsp;</td>
				</tr>
				{foreach from=$order_info.taxes item=tax_data}
				<tr>
					<td style="text-align: right; white-space: nowrap; font-size: 15px; font-family: Arial;">{$tax_data.description}&nbsp;{include file="common_templates/modifier.tpl" mod_value=$tax_data.rate_value mod_type=$tax_data.rate_type}{if $tax_data.price_includes_tax == "Y" && ($settings.Appearance.cart_prices_w_taxes != "Y" || $settings.General.tax_calculation == "subtotal")}&nbsp;{$lang.included}{/if}{if $tax_data.regnumber}&nbsp;({$tax_data.regnumber}){/if}:&nbsp;</td>
					<td style="text-align: right; white-space: nowrap; font-size: 15px; font-family: Arial;">{include file="common_templates/price.tpl" value=$tax_data.tax_subtotal}</td>
				</tr>
				{/foreach}
				{/if}
				{if $order_info.tax_exempt == 'Y'}
				<tr>
					<td style="text-align: right; white-space: nowrap; font-size: 15px; font-family: Arial;"><b>{$lang.tax_exempt}</b></td>
					<td style="text-align: right; white-space: nowrap; font-size: 15px; font-family: Arial;">&nbsp;</td>
				</tr>
				{/if}
				...
				<tr>
					<td style="text-align: right; white-space: nowrap; font-size: 15px; font-family: Arial;">{$lang.payment_surcharge}:&nbsp;</td>
					<td style="text-align: right; white-space: nowrap; font-size: 15px; font-family: Arial;"><b>{include file="common_templates/price.tpl" value=$order_info.payment_surcharge}</b></td>
				</tr>
				{/if}
				...
				<tr>
					<td style="text-align: right; white-space: nowrap; font-size: 15px; font-family: Arial;"><b>{$lang.shipping_cost}:</b>&nbsp;</td>
					<td style="text-align: right; white-space: nowrap; font-size: 15px; font-family: Arial;">{include file="common_templates/price.tpl" value=$order_info.display_shipping_cost}</td>
				</tr>
				{/if}
				
{if $order_info.points_info.in_use}
				<tr>
					<td style="text-align: right; white-space: nowrap; font: 15px Tahoma; text-align: right;">{$lang.print_shipping_cluesbucks}:&nbsp;</td>
					<td style="text-align: right; white-space: nowrap; font: 15px Tahoma; text-align: right;">-{include file="common_templates/price.tpl" value=$order_info.points_info.in_use.cost}</td>
				</tr>
{/if}
				...
				<tr>
					...
					<td style="text-align: right; white-space: nowrap; font: 15px Tahoma; text-align: right;">{include file="common_templates/price.tpl" value=$order_info.total}</td>
				</tr>
				</table>
				</td>
			</tr>
