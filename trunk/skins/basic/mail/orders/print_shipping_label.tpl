	...
	<div style="background-color: #ffffff; border: 1px solid #999; margin: 0px auto; padding: 0px 12px 0px 12px; width:420px; text-align: left;">
		...
		<tr valign="top">
			...
			<td width="54%">
                ...
                <h3 style="border: 1px solid #000000;font: bold 18px Tahoma;height: 70px;margin: 0;padding: 27px 0 3px 1px;text-align: center;">Cash On Delivery <br />Please Collect: <br />{include file="common_templates/price.tpl" value=$order_info.total} Only</h3>
				{else}
...
{/if}
			...
			{hook name="orders:items_list_row"}
				...
				<tr>
					...
					<td style="padding: 5px 10px; background-color: #ffffff; text-align: center; font-size: 10px; font-family: Arial;">{$oi.product|unescape|default:$lang.deleted_product}
