{* $Id: pages_form_elements.tpl 12452 2011-05-13 11:33:14Z alexions $ *}
{literal}
...
<tr class="no-border">
	...
	<td>
		{include file="buttons/multiple_buttons.tpl" item_id="add_elements" on_add="fn_go_check_element_type(this.id, '`$selectable_elements`');"}</td>
</tr>
