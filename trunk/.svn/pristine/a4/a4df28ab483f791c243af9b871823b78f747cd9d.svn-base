...
<div id="est_box{$id_suffix}" align="right">
	...
	{/if}
		...
		<div class="form-field">
			...
			<input type="tel" class="input-text" id="{$prefix}elm_zipcode{$id_suffix}" name="customer_location[zipcode]" size="{if $location != "sidebox"}25{else}20{/if}" value="{$cart.user_data.s_zipcode}" />
		</div>
