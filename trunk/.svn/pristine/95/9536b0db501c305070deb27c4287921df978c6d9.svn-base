...
<div id="content_payment" class="hidden">
	...
	<tr {cycle values="class=\"table-row\", "}>
		<td>
			<input type="checkbox" name="conditions[payment][]" value="{$payment.payment_id}" {if $conditions.payment[$payment.payment_id]}checked="checked"{/if} class="checkbox cm-item-payment" /></td>
		<td>
			{$payment.payment}</td>
...
<div id="content_location" class="hidden">
	...
	<tr {cycle values="class=\"table-row\", "}>
		<td class="center">
			<input name="conditions[location][]" value="{$destination.destination_id}" type="checkbox" {if $conditions.location[$destination.destination_id]}checked="checked"{/if} class="checkbox cm-item-location" /></td>
		<td>
...
<div id="content_status" class="hidden">
	...
	<tr {cycle values="class=\"table-row\", "}>
		<td class="center">
			<input name="conditions[status][]" value="{$id}" type="checkbox" {if $conditions.status.$id}checked="checked"{/if} class="checkbox cm-item-status" /></td>
		<td>
			{$status}</td>
	</tr>
	{foreachelse}
