{* $Id: add_to_cart.tpl 12771 2011-06-24 11:10:48Z subkey $ *}
...
{hook name="buttons:add_to_cart"}
	...
	{if $settings.General.allow_anonymous_shopping == "Y" || $auth.user_id}
		{include file="buttons/button.tpl" but_id=$but_id but_text=$but_text but_name=$but_name but_onclick=$but_onclick but_href=$but_href but_target=$but_target but_role=$but_role|default:"text"}
	{else}
