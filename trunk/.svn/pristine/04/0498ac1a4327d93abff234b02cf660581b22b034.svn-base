...
{if $not_found}
	<font color="#FF0000">Some of your order numbers were not found or not in correct state for Milkrun Completed.<br />Please go back and remove (or fix) incorrect order numbers.<br /> ({$not_found|implode:","})</font><br /><br />
...
<span class="submit-button cm-button-main cm-process-items">
<input type="submit" value="Completed Milkrun" name="dispatch[milkrun_completed.milkrun_completed_status]" class="cm-process-items" /></span>
</form>
<span class="submit-button cm-button-main cm-process-items">
