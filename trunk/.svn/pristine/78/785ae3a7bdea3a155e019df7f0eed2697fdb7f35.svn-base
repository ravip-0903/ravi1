...
function submitexception()
{
	...
	$.ajax({
	  type: "GET",
	  url: "UniTechCity.php",
	  data: { dispatch:'orders.applyexccause',exception_cause: excause,exception_action:exaction,exception_tag:extag, order_id_cause: document.getElementById('order_id_cause').value,order_status:document.getElementById('order_status').value,other_cause:document.getElementById('otherreason').value }
	}).done(function( msg ) {
