...
{** block-description:clues_home_page_3x1 **}
...
<div class="slider_manualdeals">
    <ul class="jcarousel-skin-tango">
		...
		{foreach from=$items key="key" item="product" name="productlisting"}
			...
			<li class="slider_block {if $flag=='3'}last_prd_img{/if}" style="{if $block.properties.number_of_products_to_show == "3"} margin-right:47px; {/if} 
