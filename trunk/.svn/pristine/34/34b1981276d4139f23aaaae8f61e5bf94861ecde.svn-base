{* $Id: totals.tpl 12143 2011-03-31 12:02:30Z subkey $ *}
...
<tr valign="top">
	...
	<ul class="statistic-list">
		...
		<li class="toggle-elm">
			...
			<span {if !$custom_ship_exists}style="display: none;"{/if} id="manual_shipping_{$key}">{$currencies.$primary_currency.symbol}&nbsp;<input type="text" class="input-text" size="5" name="stored_shipping_cost[{$key}]" value="{$cart.shipping.$key.rates|@array_sum|fn_format_price:$primary_currency:null:false}" /></span></span>
		</li>
		{/foreach}
		{/if}
