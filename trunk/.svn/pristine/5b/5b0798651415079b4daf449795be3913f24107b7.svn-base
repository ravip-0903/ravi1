...
{if $controller=='products' and $mode=='search'}
	...
	<a href="{"products.view&product_id=`$product.product_id`"|fn_url}{$url}" class="box_metacategory_image {if !$config.fb_user_engagement && $product.product_amount_available == 0}sold_out_category{/if}" id="{$product.product_id}" onclick="productCookie('{$product.product_id}','{$key}','{$last_price}');">

{else}
<a href="{"products.view?product_id=`$product.product_id`"|fn_url}" class="box_metacategory_image {if !$config.fb_user_engagement && $product.product_amount_available == 0}sold_out_category{/if}" id="{$product.product_id}">
...
<a href="{"products.view&product_id=`$product.product_id`"|fn_url}{$url}" id="{$product.product_id}" class="box_metacategory_image
    {if !$config.fb_user_engagement && $product.product_amount_available == 0}sold_out_category{/if}" onclick="productCookie('{$product.product_id}','{$key}','{$last_price}');">
