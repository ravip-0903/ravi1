{* $Id: details.tpl 12143 2011-03-31 12:02:30Z subkey $ *}
...
{* Added by Sudhir *}
<br /><label for="elm_status">{$lang.staffcomment}:</label>
<fieldset>
<textarea name="staffcomment" cols="55" rows="8" class="input-textarea-long"></textarea>
</fieldset>
