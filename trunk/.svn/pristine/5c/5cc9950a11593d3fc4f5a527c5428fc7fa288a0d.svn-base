{* $Id: update.tpl 11890 2011-02-22 10:25:13Z zeke $ *}
...
<div class="cm-tabs-content" id="tabs_content_{$id}">
	...
	<fieldset>
        ...
        <div class="form-field">
			<label for="staff_notes_{$id}">{$lang.staff_notes}:</label>
			<textarea id="staff_notes_{$id}" name="option_data[staff_notes]" cols="55" rows="8" class="cm-wysiwyg input-textarea-long">{$option_data.staff_notes}</textarea>
