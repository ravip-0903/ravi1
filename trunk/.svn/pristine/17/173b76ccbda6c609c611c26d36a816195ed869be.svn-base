...
<fieldset>
	...
	<div class="form-field">
		<label for="internal_name" class="cm-required">{$lang.internal_name}:</label>
		<input type="text" name="promotion_data[internal_name]" id="internal_name" size="25" value="{$promotion_data.internal_name}" class="input-text-large main-input" />
	</div>
