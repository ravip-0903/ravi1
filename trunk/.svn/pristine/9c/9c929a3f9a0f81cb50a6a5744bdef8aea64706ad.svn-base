{** block-description:new_arrivals_hr_block **}
...
<script>
    ...
    $(document).ready(function(){
        ...
        var url = "http://api.targetingmantra.com/TMWidgets?w=na&mid=130915&pid="+prod_id+"&limit="+limit +"&json=true&catid="+cat_id+"&callback=?";
