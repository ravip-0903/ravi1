...
<tr>
	...
	<th><a class="{$ajax_class}" href="{"`$url_prefix``$c_url`&amp;sort_by=start_price&amp;sort_order=`$search.sort_order`"|fn_url}" rev="pagination_contents">{$lang.start_price}</a>{if $search.sort_by == "start_price"}{$sort_sign}{/if}</th>
...
<tr class="{$row_class_name}">
	...
	<td class="right">{include file="common_templates/price.tpl" value=$sub.start_price}</td>
