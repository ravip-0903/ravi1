...
<div class="form-field">
	<label for="product_description_product">Merchant Reference number:</label>
	<span class="input-helper"><input type="text" name="product_data[merchant_reference_number]" id="merchant_reference_number" size="55" value="{$product_data.merchant_reference_number}" class="input-text-large main-input" /></span>
</div>

<div class="form-field">
	<label for="product_description_product" >Manufacturer Reference number:</label>
	<span class="input-helper"><input type="text" name="product_data[manufacturer_reference_number]" id="manufacturer_reference_number" size="55" value="{$product_data.manufacturer_reference_number}" class="input-text-large main-input" /></span>
</div>

<div class="form-field">
	<label for="product_description_product">Manufacturer Reference type:</label>
	<span class="input-helper"><input type="text" name="product_data[manufacturer_reference_type]" id="manufacturer_reference_type" size="55" value="{$product_data.manufacturer_reference_type}" class="input-text-large main-input" /></span>
</div>
