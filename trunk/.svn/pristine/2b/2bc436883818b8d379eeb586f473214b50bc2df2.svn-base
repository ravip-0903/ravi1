...
We encourage you to retry confirming your order by going to your #{$order_info.order_id} by going to <a href="http://shopclues.com/index.php?dispatch=orders.details&order_id={$order_info.order_id}"> Order detail</a> and clicking on "Reorder this Order" button on the top right of this screen. <br/><br/>
