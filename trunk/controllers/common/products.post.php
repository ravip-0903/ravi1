...
if ($mode == 'picker') {
   if(ACCOUNT_TYPE !='customer'){ // This condition added by Sudhir dt 19th Dec 2012 to stop advance search for customer through 
	$params = $_REQUEST;
	$params['extend'] = array('description');
	$params['skip_view'] = 'Y';

if(isset($params['q'])){ // Condition added by sudhir dt 1st Nov 2012 to stop queries at click of add product popup
