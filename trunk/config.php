...
//define('DIR_CUSTOM_FILES', DIR_ROOT . '/images/custom_files/');
define('DIR_CUSTOM_FILES', DIR_ROOT . '/users/custom_files/');
define('DIR_CUSTOM_FILES_USER', DIR_ROOT . '/images/custom_files/');
...
define('SESSIONS_STORAGE_ALIVE_TIME',  1440); // 24 mins
...
//define('FILTERS_RANGES_COUNT', 5);
//define('FILTERS_RANGES_MORE_COUNT', 20);
define('FILTERS_RANGES_COUNT', 10000);
define('FILTERS_RANGES_MORE_COUNT', 10000);
