...
//
// $Id: admin.php 12865 2011-07-05 06:57:22Z 2tl $
//
...
$schema = array (
	...
	'upload_transactional_data'=>array('permissions'=>'upload_transaction_file'),
	'orders_exception'=>array(
		'modes'=>array(
			'to_reconcile'=>array('permissions'=>'to_reconcile_order'),
			'reconcile_list'=>array('permissions'=>'view_reconcile_order')
			           )),
	'review_monitoring'=>array(
		'modes'=>array(					   
			'product_review'=>array('permissions'=>'manage_discussions'),
			'merchant_review'=>array('permissions'=>'manage_discussions')
					   )
		),
	'taxes' => array (
		'modes' => array (
	...
	/* Start for addon permission */
	'vendor_terms' => array (
			'modes' => array (
				'manage' => array (
					'permissions' => 'sdeep_terms',
				),
			),
		'permissions' => 'sdeep_terms',
		),
	...
	'sdeep_ratings' => array (
			'modes' => array (
				'manage' => array (
					'permissions' => 'sdeep_configure_ratings',
				),
			),
		'permissions' => 'sdeep_configure_ratings',
		),
	/* End for addons permission */
	'usergroups' => array (
		'modes' => array (
			'update_status' => array (
