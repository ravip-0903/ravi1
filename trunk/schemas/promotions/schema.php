...
//
// $Id: schema.php 12865 2011-07-05 06:57:22Z 2tl $
//
...
$schema['conditions'] = array (
	...
	'categories' => array (
		...
		'field_function' => array('array_keys', '@cart.companies'),
		'zones' => array('cart')
	),
	'products' => array (
		'operators' => array ('in', 'nin'),
	...
	'email_like' => array (
		'operators' => array ('eq', 'neq'),
		'type' => 'input',
		'field_function' => array('fn_promotion_validate_email', '#this', '@cart', '#id'),
		'zones' => array('cart'),
	),
        'category_subtotal' => array (
		'operators' => array ('eq', 'neq', 'lte', 'gte', 'lt', 'gt'),
		'type' => 'input',
                'field_function' => array('fn_promotion_validate_category_subtotal', '#this', '@cart', '#id'),
		'zones' => array('cart')
	),
	...
	'new_customer_only' => array (
		'type' => 'statement',
		'field_function' => array('fn_promotion_validate_new_customer', '#id', '#this', 'new_customer_only', '@cart', '@auth'),
		'zones' => array('cart')
	),
	'auto_coupons' => array (
		'type' => 'list',
