...
CALLBACK;
	...
	if ($processor_data['params']['test'] == 'Y') {
		$scripts .= '<script language=javascript src="https://payments-sandbox.amazon.com/cba/js/PaymentWidgets.js"></script>';
	} else {
		$scripts .= '<script language=javascript src="https://static-na.payments-amazon.com/cba/js/us/PaymentWidgets.js"></script>';
	}
