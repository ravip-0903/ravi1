...
class PostLibPHP{
	...
	function readPropFile()
	{
		...
		$fp = fopen (DIR_ROOT ."/payments/icici/sfa.properties","r");
...
//echo getcwd() . "/payments/icici/Sfa/cacert.pem";die;
		// Initialisation
		$ch=curl_init();
		...
		curl_setopt($ch, CURLOPT_CAINFO, getcwd() . "/payments/icici/Sfa/cacert.pem");
