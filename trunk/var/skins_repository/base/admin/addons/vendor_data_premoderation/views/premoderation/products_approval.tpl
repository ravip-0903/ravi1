{* $Id: products_approval.tpl 12476 2011-05-18 05:53:07Z 2tl $ *}
...
<tr>
	...
	<th width="20%"><a class="{$ajax_class}{if $search.sort_by == "company"} sort-link-{$search.sort_order}{/if}" href="{"`$c_url`&amp;sort_by=company&amp;sort_order=`$search.sort_order`"|fn_url}" rev="pagination_contents">{$lang.vendor}</a></th>
	<th width="15%"><a class="{$ajax_class}{if $search.sort_by == "approval"} sort-link-{$search.sort_order}{/if}" href="{"`$c_url`&amp;sort_by=approval&amp;sort_order=`$search.sort_order`"|fn_url}" rev="pagination_contents">{$lang.status}</a></th>
	<th>&nbsp;</th>
</tr>
