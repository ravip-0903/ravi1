...
<div class="statistics-box overall">
	<div class="statistics-body">
		<a href="{"orders.manage?time_from=`$date.today`&time_to=`$date.TIME`&period=C"|fn_url}" class="section"><span class="price">{include file="common_templates/price.tpl" value=$orders_stats.daily_orders.totals.total_paid} </span><u>{$lang.today}</u> <div>{$lang.prev} {include file="common_templates/price.tpl" value=$orders_stats.daily_orders.prev_totals.total_paid} <span class="percent-{if $orders_stats.daily_orders.totals.profit >= 0}up{else}down{/if}">{if $orders_stats.daily_orders.totals.profit}({if $orders_stats.daily_orders.totals.profit >= 0}+{/if}{$orders_stats.daily_orders.totals.profit}%){/if}</span></div></a>
		
		<a href="{"orders.manage?time_from=`$date.week`&time_to=`$date.TIME`&period=C"|fn_url}" class="section"><span class="price">{include file="common_templates/price.tpl" value=$orders_stats.weekly_orders.totals.total_paid} </span><u>{$lang.week}</u> <div>{$lang.prev} {include file="common_templates/price.tpl" value=$orders_stats.weekly_orders.prev_totals.total_paid} <span class="percent-{if $orders_stats.weekly_orders.totals.profit >= 0}up{else}down{/if}">{if $orders_stats.weekly_orders.totals.profit}({if $orders_stats.weekly_orders.totals.profit >= 0}+{/if}{$orders_stats.weekly_orders.totals.profit}%){/if}</span></div></a>
		
		<a href="{"orders.manage?time_from=`$date.month`&time_to=`$date.TIME`&period=C"|fn_url}" class="section last"><span class="price">{include file="common_templates/price.tpl" value=$orders_stats.monthly_orders.totals.total_paid} </span><u>{$lang.month}</u> <div>{$lang.prev} {include file="common_templates/price.tpl" value=$orders_stats.monthly_orders.prev_totals.total_paid} <span class="percent-{if $orders_stats.monthly_orders.totals.profit >= 0}up{else}down{/if}">{if $orders_stats.monthly_orders.totals.profit}({if $orders_stats.monthly_orders.totals.profit >= 0}+{/if}{$orders_stats.monthly_orders.totals.profit}%){/if}</span></div></a>
	</div>
</div>
