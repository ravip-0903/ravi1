{* $Id: manage_items.tpl 12307 2011-04-21 10:54:49Z bimib $ *}
...
{if $block.properties.per_object}
	<fieldset>
		<textarea id="block_text" name="block_items[block_data][block_text]" cols="65" rows="8" class="cm-wysiwyg input-textarea">{$block.item_ids.block_text}</textarea>
