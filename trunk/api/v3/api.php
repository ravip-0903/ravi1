...
elseif($func == 'fblogin' || $func == 'fbcheckout' || $func == 'glogin' || $func == 'gcheckout'){
        $file = 'social_media_login.php';
        $class = 'SocialLogin';
        require  DIR_ROOT . '/api/'.$VERSION_DIR.'/lib/facebook-sdk/src/facebook.php';			
		require_once DIR_ROOT . '/api/'.$VERSION_DIR.'/lib/google-login'.'/src/Google_Client.php';
		require_once DIR_ROOT . '/api/'.$VERSION_DIR.'/lib/google-login'.'/src/contrib/Google_Oauth2Service.php';	
}
elseif ($func=='cat_leaf_features' || $func=='cat_features' || $func=='cat_category_tree' || $func=='cat_categories' || $func=='cat_options' || $func=='cat_leaf_options'){
        $file = 'Catalog.php';
        $class = 'Catalog';
}
