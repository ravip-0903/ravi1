...
if($func == 'login' || $func == 'signup'){
        ...
        $file = 'category.php';
        $class = 'categories';
        require  dirname(__FILE__) . '/../addons/discussion/func.php';
...
elseif($func == 'pages'){
        ...
        $file = 'wishlist.php';
        $class = 'user_wishlist';
        require  dirname(__FILE__) . '/../addons/wishlist/controllers/customer/wishlist.php';
}elseif($func == 'ivr'){
        $class = 'ivr';
        $file = 'ivr.php';
}
...
elseif($func == 'checkout'){
        ...
        $file = 'checkout.php';
        $class = 'checkout';
        require  dirname(__FILE__) . '/../controllers/customer/checkout.php'; 
}

if (file_exists(DIR_ROOT . '/api/method/'.$file)) {
        include(DIR_ROOT . '/api/method/'.$file);
}
